#Contains the class that represents the 3rd floor of DBH.
...
class Area3_2(area_base.Area):
    ...
    def gen_patrol_route1(self, enemy):
        ...
        if self.e_group != None:
            ...
            enemy.patrol_route = [("look_north", 15), ("look_south", 15), ("look_east", 15), ("look_west", 15), ("end", 0)]
    ...
    def gen_patrol_route2(self, enemy):
        ...
        if self.e_group != None:
            ...
            enemy.patrol_route = [("look_south", 15), ("look_west", 15), ("look_north", 15), ("look_east", 15), ("end", 0)]
